...
from core.views import home, about, services, team, blog, blog_details, service_details, contact, register, custom_login, profile, booking, dashboard, receptionist_dashboard, client_dashboard, update_appointment_status, receptionist_login, manage_categories, delete_category, manage_employees, inbox, settings_view
from django.contrib.auth.views import LogoutView

urlpatterns = [
    path('admin/', admin.site.urls),
    path('gestao/login/', receptionist_login, name='receptionist_login'), # Management Login
    path('', home, name='home'),
